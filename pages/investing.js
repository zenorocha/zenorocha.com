...
function Investing(props) {
  ...
  return (
    <div className="single">
      ...
      <p>I write $5-10k checks in <strong>developer-first startups</strong>. I prefer folks who are in early stages (think pre-seed or seed) and products that increase productivity, avoid task repetition, or improve performance.</p>
      ...
      <ul>
        ...
        <li><strong>Branding</strong> - building a company brand that developers love, admire, and get inspired from.</li>
      ...
      <h2>Let's chat</h2>
      <p>Hit me up if what you saw here makes sense to you.</p>
    </div>
  )
}
