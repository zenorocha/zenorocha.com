export const PostMain = ({ className = '', ...props }) => (
  <main
    className={`mx-auto flex w-full max-w-200 flex-1 items-start py-14 md:py-28 ${className}`}
    {...props}
  />
);
